  ...
  <div class="misc-wrapper" style="margin: 40px !important">
    ...
    <ul>
      ...
      <li>
        ...
        refers to Lost Doggo, that is responsible for your information under
        this Cookie Policy.
      </li>
      <li>
        Device:&nbsp;any internet connected device such as a phone, tablet,
        computer or any other device that can be used to visit Lost Doggo and
        use the services.
      </li>
      <li>
      ...
      <li>
        Service: refers to the service provided by Lost Doggo as described in
      ...
      <li>Website: site, which can be accessed via this URL: lostdoggo.com</li>
    </ul>
    <p>
    ...
    <h1>Introduction</h1>
    <p>
      This Cookie Policy explains how Lost Doggo and its affiliates
      (collectively "Lost Doggo", "we", "us", and "ours"), use cookies and
      similar technologies to recognize you when you visit our website/app,
      including without limitation lostdoggo.com and any related URLs, mobile or
    ...
    <ul>
      ...
      <li>
        You: a person or entity that is registered with Lost Doggo to use the
        Services.
      </li>
    </ul>

    <h1>What type of cookies does Lost Doggo use?</h1>
    <p>
    ...
    <p>
      ...
      can be found at:&nbsp;https://www.google.com/policies/privacy/partners/.
    ...
    <p>
      ...
      party basis by Lost Doggo. The Websites can be embedded with content from
